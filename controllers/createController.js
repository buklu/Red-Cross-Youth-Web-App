...
exports.addCouncil=async(req, res)=>{    
    ...
    const councilInstance=await Council.model.create({
        user_id: userInstance.id,
        chapter_id: req.session.chapter_id,
        category: req.body.category,
        name: req.body.councilName,
    })
    await Committee.model.bulkCreate([
                {council_id:councilInstance.dataValues['id'],type: 'DRRM', no_of_members:0},
                {council_id:councilInstance.dataValues['id'],type: 'Pledge 25', no_of_members:0},
                {council_id:councilInstance.dataValues['id'],type: 'Trainings', no_of_members:0},
                {council_id:councilInstance.dataValues['id'],type: 'Council Dev', no_of_members:0},
                {council_id:councilInstance.dataValues['id'],type: 'YAPE', no_of_members:0},
                {council_id:councilInstance.dataValues['id'],type: 'YPE', no_of_members:0},
                {council_id:councilInstance.dataValues['id'],type: 'Health Services', no_of_members:0},
                {council_id:councilInstance.dataValues['id'],type: 'Welfare', no_of_members:0},
                {council_id:councilInstance.dataValues['id'],type: 'Awards and Recognition', no_of_members:0},
                {council_id:councilInstance.dataValues['id'],type: 'Safety', no_of_members:0}            
    ])    
}
